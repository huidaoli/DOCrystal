...
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#F1B000">
    <td colspan="3" valign="bottom"><table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
     <td><a href="http;//huidaoli.web-164.com"><img src="images/banner.gif" width="200" height="65" alt="水晶礼品商城" longdesc="http://www.can2do.com"></a></td>
<!--       <a href="http://www.can2do.com"><td width="121" height="100" background="images/banner.gif">&nbsp;</td></a>-->
        <td width="645" align="right" bgcolor="#F1B000"><table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="12" align="right">&nbsp;&nbsp;</td>
            </tr>
            <tr>
              <td><a href=# onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.can2do.com');">设为首页</a> | <a href="javascript:window.external.addFavorite('http://www.can2do.com/','水晶礼品商城');">加入收藏 </a><a href="mailto:song.li@can2do.com">| 联系我们</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
